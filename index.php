...
<html lang="en">
<head>
   <title>India Bank - Your Trust is our No1 Priority</title>
   <meta charset="utf-8">
...
<body>
<body style="background-image : url(images/whitewall1.jpg)">
<!-- Navigation bar-->
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="https://economictimes.indiatimes.com/markets/forex/currency-converter?from=mdr">Currency Conversion </a>
        </li>
